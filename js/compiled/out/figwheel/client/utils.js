...
var or__28139__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj44109 = {"detail":data};
return obj44109;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28127__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28127__auto__)){
var and__28127__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__44116 = cljs.core._EQ_;
var expr__44117 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__44116.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__44117))){
return ((function (pred__44116,expr__44117){
return (function (p1__44110_SHARP_){
return console.warn(p1__44110_SHARP_);
});
;})(pred__44116,expr__44117))
} else {
if(cljs.core.truth_(pred__44116.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__44117))){
return ((function (pred__44116,expr__44117){
return (function (p1__44111_SHARP_){
return console.debug(p1__44111_SHARP_);
});
;})(pred__44116,expr__44117))
} else {
if(cljs.core.truth_(pred__44116.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__44117))){
return ((function (pred__44116,expr__44117){
return (function (p1__44112_SHARP_){
return console.error(p1__44112_SHARP_);
});
;})(pred__44116,expr__44117))
} else {
return ((function (pred__44116,expr__44117){
return (function (p1__44113_SHARP_){
return console.log(p1__44113_SHARP_);
});
;})(pred__44116,expr__44117))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__44120){
var map__44121 = p__44120;
var map__44121__$1 = ((((!((map__44121 == null)))?((((map__44121.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44121.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44121):map__44121);
var opts = map__44121__$1;
var eval_fn = cljs.core.get.call(null,map__44121__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__44123_SHARP_);
});})(new_def))
);
...
return (function (p__44124){
var vec__44125 = p__44124;
var ky = cljs.core.nth.call(null,vec__44125,(0),null);
var v = cljs.core.nth.call(null,vec__44125,(1),null);
...
if(cljs.core.truth_((function (){var and__28127__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1506931541497
