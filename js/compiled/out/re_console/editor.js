...
return new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"add-input","add-input",-994386222),(function (p1__39003_SHARP_,p2__39004_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"add-console-input","add-console-input",-277003986),console_key,p1__39003_SHARP_,p2__39004_SHARP_], null));
}),new cljs.core.Keyword(null,"add-result","add-result",1382794315),(function (p1__39005_SHARP_,p2__39006_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"add-console-result","add-console-result",1768771531),console_key,p1__39005_SHARP_,p2__39006_SHARP_], null));
}),new cljs.core.Keyword(null,"go-up","go-up",-783282342),(function (p1__39007_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"console-go-up","console-go-up",50535611),console_key,p1__39007_SHARP_], null));
}),new cljs.core.Keyword(null,"go-down","go-down",-1002511595),(function (p1__39008_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"console-go-down","console-go-down",-1045916631),console_key,p1__39008_SHARP_], null));
}),new cljs.core.Keyword(null,"clear-items","clear-items",524826180),(function (p1__39009_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"clear-console-items","clear-console-items",-1821518386),console_key,p1__39009_SHARP_], null));
}),new cljs.core.Keyword(null,"set-text","set-text",1346789745),(function (p1__39010_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"console-set-text","console-set-text",860354388),console_key,p1__39010_SHARP_], null));
}),new cljs.core.Keyword(null,"add-log","add-log",1433037691),(function (p1__39011_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"add-console-log","add-console-log",-371208070),console_key,p1__39011_SHARP_], null));
})], null);
});
...
var and__28814__auto__ = cljs.core.complement.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [(39),null,(40),null,(38),null,(37),null], null), null)).call(null,key);
if(cljs.core.truth_(and__28814__auto__)){
var and__28814__auto____$1 = (lno === (0));
if(and__28814__auto____$1){
var or__28826__auto__ = compare_position_fn.call(null,cno_to,begin_source);
if(cljs.core.truth_(or__28826__auto__)){
return or__28826__auto__;
} else {
var and__28814__auto____$2 = !(same_pos);
...
re_console.editor.on_change = (function re_console$editor$on_change(inst,console_key,text,p__39012,mode){
...
var set_text = cljs.core.get.call(null,map__39013__$1,new cljs.core.Keyword(null,"set-text","set-text",1346789745));
...
return ((function (on_after_change,on_before_change,map__39013,map__39013__$1,set_text){
...
;})(on_after_change,on_before_change,map__39013,map__39013__$1,set_text))
});
re_console.editor.on_keydown = (function re_console$editor$on_keydown(console_key,p__39016,eval_opts){
...
var should_go_up = cljs.core.get.call(null,map__39017__$1,new cljs.core.Keyword(null,"should-go-up","should-go-up",2137977547));
var should_go_down = cljs.core.get.call(null,map__39017__$1,new cljs.core.Keyword(null,"should-go-down","should-go-down",473755082));
var go_up = cljs.core.get.call(null,map__39017__$1,new cljs.core.Keyword(null,"go-up","go-up",-783282342));
var go_down = cljs.core.get.call(null,map__39017__$1,new cljs.core.Keyword(null,"go-down","go-down",-1002511595));
return ((function (map__39017,map__39017__$1,should_go_up,should_go_down,go_up,go_down){
return (function (inst,evt){
if(cljs.core.truth_(re_console.editor.modifying_prompt_QMARK_.call(null,inst,evt.keyCode))){
return evt.preventDefault();
} else {
var G__39019 = evt.keyCode;
switch (G__39019) {
case (13):
var source = re_console.common.source_without_prompt.call(null,inst.getValue());
if(cljs.core.truth_((function (){var and__28814__auto__ = cljs.core.not.call(null,evt.shiftKey);
...
return new cljs.core.Keyword(null,"evaluate","evaluate",1525218437).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,eval_opts)).call(null,((function (source,G__39019,map__39017,map__39017__$1,should_go_up,should_go_down,go_up,go_down){
return (function (p1__39015_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"on-eval-complete","on-eval-complete",436163213),console_key,p1__39015_SHARP_], null));
});})(source,G__39019,map__39017,map__39017__$1,should_go_up,should_go_down,go_up,go_down))
,source);
} else {
return null;
}
...
;})(map__39017,map__39017__$1,should_go_up,should_go_down,go_up,go_down))
});
...
var current_line = cljs.core.deref.call(null,cm).getLine((function (){var x__29183__auto__ = (cljs.core.deref.call(null,cm).lineCount() - (1));
var y__29184__auto__ = line_idx;
...
var G__39021 = cljs.core.rest.call(null,exclude_chars);
exclude_chars = G__39021;
continue;
} else {
return char_index;
}
...
//# sourceMappingURL=editor.js.map?rel=1506931008471
