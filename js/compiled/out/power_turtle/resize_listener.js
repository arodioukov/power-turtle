...
power_turtle.resize_listener.on_window_resize = (function power_turtle$resize_listener$on_window_resize(e){
return cljs.core.reset_BANG_.call(null,power_turtle.resize_listener.window_width,window.innerWidth);
});
if(typeof power_turtle.resize_listener.listener !== 'undefined'){
} else {
power_turtle.resize_listener.listener = window.addEventListener("resize",power_turtle.resize_listener.on_window_resize);
}
