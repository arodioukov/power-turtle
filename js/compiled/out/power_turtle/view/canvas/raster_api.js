 ...
 */
power_turtle.view.canvas.raster_api.color = (function power_turtle$view$canvas$raster_api$color(c){
...
power_turtle.view.canvas.raster_api._STAR_color_STAR_ = c;

return null;
});
power_turtle.view.canvas.raster_api.plot_STAR_ = (function power_turtle$view$canvas$raster_api$plot_STAR_(r,x,y,c){
 ...
 */
power_turtle.view.canvas.raster_api.plot = (function power_turtle$view$canvas$raster_api$plot(x,y){
...
cljs.core.swap_BANG_.call(null,power_turtle.view.canvas.raster_api.raster,power_turtle.view.canvas.raster_api.plot_STAR_,x,y,power_turtle.view.canvas.raster_api._STAR_color_STAR_);

return null;
});
power_turtle.view.canvas.raster_api.lin = (function power_turtle$view$canvas$raster_api$lin(r,a1,a2,b,c,f){
if((a2 < a1)){
return power_turtle.view.canvas.raster_api.lin.call(null,r,a2,a1,b,c,f);
} else {
...
power_turtle.view.canvas.raster_api.hlin_STAR_ = (function power_turtle$view$canvas$raster_api$hlin_STAR_(r,x1,x2,y,c){
return power_turtle.view.canvas.raster_api.lin.call(null,r,x1,x2,y,c,cljs.core.identity);
});
/**
 ...
 */
power_turtle.view.canvas.raster_api.hlin = (function power_turtle$view$canvas$raster_api$hlin(x1,x2,y){
...
cljs.core.swap_BANG_.call(null,power_turtle.view.canvas.raster_api.raster,power_turtle.view.canvas.raster_api.hlin_STAR_,x1,x2,y,power_turtle.view.canvas.raster_api._STAR_color_STAR_);

return null;
});
power_turtle.view.canvas.raster_api.vlin_STAR_ = (function power_turtle$view$canvas$raster_api$vlin_STAR_(r,y1,y2,x,c){
return power_turtle.view.canvas.raster_api.lin.call(null,r,y1,y2,x,c,cljs.core.reverse);
});
/**
 ...
 *   The x and y numbers must be between 0 and 39.
 */
power_turtle.view.canvas.raster_api.vlin = (function power_turtle$view$canvas$raster_api$vlin(y1,y2,x){
...
cljs.core.swap_BANG_.call(null,power_turtle.view.canvas.raster_api.raster,power_turtle.view.canvas.raster_api.vlin_STAR_,y1,y2,x,power_turtle.view.canvas.raster_api._STAR_color_STAR_);

return null;
});
power_turtle.view.canvas.raster_api.scrn_STAR_ = (function power_turtle$view$canvas$raster_api$scrn_STAR_(r,x,y){
 ...
 *   Both x and y must be between 0 and 39.
 */
power_turtle.view.canvas.raster_api.scrn = (function power_turtle$view$canvas$raster_api$scrn(x,y){
if(cljs.core.integer_QMARK_.call(null,x)){
} else {
throw (new Error("Assert failed: (integer? x)"));
}
