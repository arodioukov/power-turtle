...
var reader = (function (){var or__28826__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__28826__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__28826__auto__)){
return or__28826__auto__;
} else {
return (128);
...
var map__44842 = top_item;
var map__44842__$1 = ((((!((map__44842 == null)))?((((map__44842.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44842.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44842):map__44842);
var file = cljs.core.get.call(null,map__44842__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__44842__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__44842__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e44841){var _e = e44841;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___44844 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___44844)){
var seen_errors_44845 = temp__4655__auto___44844;
if(cljs.core.truth_(seen_errors_44845.has(self))){
} else {
seen_errors_44845.add(self);

var temp__4657__auto___44846 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___44846)){
var sense_44847 = temp__4657__auto___44846;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_44847)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1506931027425
