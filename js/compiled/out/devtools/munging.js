...
var o42947 = temp__4655__auto__;
var temp__4655__auto____$1 = (o42947["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o42948 = temp__4655__auto____$1;
return (o42948["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__42060__auto__ = f;
return (o__42060__auto__["toString"]).call(o__42060__auto__);
} else {
return "";
}
}catch (e42949){var _ = e42949;
return "";
}});
...
try{var o__42060__auto___42951 = t;
(o__42060__auto___42951["cljs$lang$ctorPrWriter"]).call(o__42060__auto___42951,t,writer);
}catch (e42950){var __42952 = e42950;
}
...
var char_code = (function (){var o__42060__auto__ = (new String(char$));
return (o__42060__auto__["charCodeAt"]).call(o__42060__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__42060__auto__ = String;
return (o__42060__auto__["fromCharCode"]).call(o__42060__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42953 = num_code;
switch (G__42953) {
case (1):
return (185);
...
var o__42060__auto__ = String;
return (o__42060__auto__["fromCharCode"]).call(o__42060__auto__,superscript_code);
});
/**
...
}catch (e42955){var _e__42067__auto__ = e42955;
return false;
}})())){
...
var vec__42956 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__42956,(0),null);
...
var or__28826__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o42959 = temp__4655__auto__;
var temp__4655__auto____$1 = (o42959["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o42960 = temp__4655__auto____$1;
return (o42960["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29995__auto___42967 = arguments.length;
var i__29996__auto___42968 = (0);
while(true){
if((i__29996__auto___42968 < len__29995__auto___42967)){
args__30002__auto__.push((arguments[i__29996__auto___42968]));

var G__42969 = (i__29996__auto___42968 + (1));
i__29996__auto___42968 = G__42969;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__30003__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42963){
var vec__42964 = p__42963;
var ns_detector = cljs.core.nth.call(null,vec__42964,(0),null);
var effective_detector = (function (){var or__28826__auto__ = ns_detector;
if(cljs.core.truth_(or__28826__auto__)){
return or__28826__auto__;
} else {
...
var G__42970 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__42971 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__42970;
remaining_tokens = G__42971;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42961){
var G__42962 = cljs.core.first.call(null,seq42961);
var seq42961__$1 = cljs.core.next.call(null,seq42961);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__42962,seq42961__$1);
});
...
var vec__42975 = cljs.core.split_with.call(null,(function (p1__42974_SHARP_){
return cljs.core.not_EQ_.call(null,p1__42974_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__42975,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__42975,(1),null);
...
var vec__42978 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__42978,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__42978,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__42981 = cljs.core.rest.call(null,remaining_tokens);
var G__42982 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__42981;
name_tokens = G__42982;
continue;
} else {
...
var vec__42985 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__42985,(0),null);
var arity = cljs.core.nth.call(null,vec__42985,(1),null);
var vec__42988 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__42988,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__42988,(1),null);
var vec__42991 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__42991,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__42991,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__42991,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__42991,(3),null);
...
var vec__42997 = result;
var munged_ns = cljs.core.nth.call(null,vec__42997,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__42997,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__42997,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__42997,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__42997,(4),null);
var arity = cljs.core.nth.call(null,vec__42997,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__43001 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__43001,(0),null);
var args = cljs.core.nth.call(null,vec__43001,(1),null);
var vec__43004 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__43004,(0),null);
var name = cljs.core.nth.call(null,vec__43004,(1),null);
...
var G__43007 = (arity + (1));
var G__43008 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43009){
var vec__43010 = p__43009;
var arity = cljs.core.nth.call(null,vec__43010,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__43010,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__28826__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__28826__auto__)){
return or__28826__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__43013_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__43014_SHARP_);
...
var args__30002__auto__ = [];
var len__29995__auto___43021 = arguments.length;
var i__29996__auto___43022 = (0);
while(true){
if((i__29996__auto___43022 < len__29995__auto___43021)){
args__30002__auto__.push((arguments[i__29996__auto___43022]));

var G__43023 = (i__29996__auto___43022 + (1));
i__29996__auto___43022 = G__43023;
continue;
} else {
}
break;
...
var argseq__30003__auto__ = ((((1) < args__30002__auto__.length))?(new cljs.core.IndexedSeq(args__30002__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__30003__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43017){
var vec__43018 = p__43017;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__43018,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43015){
var G__43016 = cljs.core.first.call(null,seq43015);
var seq43015__$1 = cljs.core.next.call(null,seq43015);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__43016,seq43015__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__28826__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__28826__auto__)){
return or__28826__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__28814__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__28826__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__28826__auto__)){
return or__28826__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__43026__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__43026__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__43026__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__43026__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43027 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__43027,(0),null);
var fn_name = cljs.core.nth.call(null,vec__43027,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__43027,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__43027,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__43027,(4),null);
var arity = cljs.core.nth.call(null,vec__43027,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__28814__auto__ = protocol_ns;
if(cljs.core.truth_(and__28814__auto__)){
return cljs.core.not.call(null,(function (){var and__28814__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__28826__auto__ = protocol_part;
if(cljs.core.truth_(or__28826__auto__)){
return or__28826__auto__;
} else {
return fn_part;
...
var o__42060__auto__ = f;
return (o__42060__auto__["getBasis"]).call(o__42060__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__28814__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__28814__auto__)){
...
}catch (e43031){var _e__42067__auto__ = e43031;
...
var G__43032 = (obj[cljs.core.first.call(null,path)]);
var G__43033 = cljs.core.rest.call(null,path);
obj = G__43032;
path = G__43033;
continue;
} else {
...
var partition_bits = (function (){var or__28826__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__28826__auto__)){
return or__28826__auto__;
} else {
return (0);
...
return (function (accum,p__43034){
var vec__43035 = p__43034;
var bit = cljs.core.nth.call(null,vec__43035,(0),null);
var protocol = cljs.core.nth.call(null,vec__43035,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43038){
var vec__43039 = p__43038;
var ns = cljs.core.nth.call(null,vec__43039,(0),null);
var name = cljs.core.nth.call(null,vec__43039,(1),null);
var selector = cljs.core.nth.call(null,vec__43039,(2),null);
...
return (function (p__43043){
var vec__43044 = p__43043;
var munged_name = cljs.core.nth.call(null,vec__43044,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__43044,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__43044,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__43042_SHARP_){
return (obj[cljs.core.first.call(null,p1__43042_SHARP_)]);
});})(name,sorted_matches,vec__43044,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1506931024767
