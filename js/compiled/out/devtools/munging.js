...
var o46374 = temp__4655__auto__;
var temp__4655__auto____$1 = (o46374["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o46375 = temp__4655__auto____$1;
return (o46375["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__45931__auto__ = f;
return (o__45931__auto__["toString"]).call(o__45931__auto__);
} else {
return "";
}
}catch (e46376){var _ = e46376;
return "";
}});
...
try{var o__45931__auto___46378 = t;
(o__45931__auto___46378["cljs$lang$ctorPrWriter"]).call(o__45931__auto___46378,t,writer);
}catch (e46377){var __46379 = e46377;
}
...
var char_code = (function (){var o__45931__auto__ = (new String(char$));
return (o__45931__auto__["charCodeAt"]).call(o__45931__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__45931__auto__ = String;
return (o__45931__auto__["fromCharCode"]).call(o__45931__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__46380 = num_code;
switch (G__46380) {
case (1):
return (185);
...
var o__45931__auto__ = String;
return (o__45931__auto__["fromCharCode"]).call(o__45931__auto__,superscript_code);
});
/**
...
}catch (e46382){var _e__45938__auto__ = e46382;
return false;
}})())){
...
var vec__46383 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__46383,(0),null);
...
var or__28139__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o46386 = temp__4655__auto__;
var temp__4655__auto____$1 = (o46386["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o46387 = temp__4655__auto____$1;
return (o46387["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29308__auto___46394 = arguments.length;
var i__29309__auto___46395 = (0);
while(true){
if((i__29309__auto___46395 < len__29308__auto___46394)){
args__29315__auto__.push((arguments[i__29309__auto___46395]));

var G__46396 = (i__29309__auto___46395 + (1));
i__29309__auto___46395 = G__46396;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29316__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__46390){
var vec__46391 = p__46390;
var ns_detector = cljs.core.nth.call(null,vec__46391,(0),null);
var effective_detector = (function (){var or__28139__auto__ = ns_detector;
if(cljs.core.truth_(or__28139__auto__)){
return or__28139__auto__;
} else {
...
var G__46397 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__46398 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__46397;
remaining_tokens = G__46398;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq46388){
var G__46389 = cljs.core.first.call(null,seq46388);
var seq46388__$1 = cljs.core.next.call(null,seq46388);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__46389,seq46388__$1);
});
...
var vec__46402 = cljs.core.split_with.call(null,(function (p1__46401_SHARP_){
return cljs.core.not_EQ_.call(null,p1__46401_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__46402,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__46402,(1),null);
...
var vec__46405 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__46405,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__46405,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__46408 = cljs.core.rest.call(null,remaining_tokens);
var G__46409 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__46408;
name_tokens = G__46409;
continue;
} else {
...
var vec__46412 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__46412,(0),null);
var arity = cljs.core.nth.call(null,vec__46412,(1),null);
var vec__46415 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__46415,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__46415,(1),null);
var vec__46418 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__46418,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__46418,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__46418,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__46418,(3),null);
...
var vec__46424 = result;
var munged_ns = cljs.core.nth.call(null,vec__46424,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__46424,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__46424,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__46424,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__46424,(4),null);
var arity = cljs.core.nth.call(null,vec__46424,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__46428 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__46428,(0),null);
var args = cljs.core.nth.call(null,vec__46428,(1),null);
var vec__46431 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__46431,(0),null);
var name = cljs.core.nth.call(null,vec__46431,(1),null);
...
var G__46434 = (arity + (1));
var G__46435 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__46436){
var vec__46437 = p__46436;
var arity = cljs.core.nth.call(null,vec__46437,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__46437,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__28139__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__28139__auto__)){
return or__28139__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__46440_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__46441_SHARP_);
...
var args__29315__auto__ = [];
var len__29308__auto___46448 = arguments.length;
var i__29309__auto___46449 = (0);
while(true){
if((i__29309__auto___46449 < len__29308__auto___46448)){
args__29315__auto__.push((arguments[i__29309__auto___46449]));

var G__46450 = (i__29309__auto___46449 + (1));
i__29309__auto___46449 = G__46450;
continue;
} else {
}
break;
...
var argseq__29316__auto__ = ((((1) < args__29315__auto__.length))?(new cljs.core.IndexedSeq(args__29315__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29316__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__46444){
var vec__46445 = p__46444;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__46445,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq46442){
var G__46443 = cljs.core.first.call(null,seq46442);
var seq46442__$1 = cljs.core.next.call(null,seq46442);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__46443,seq46442__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__28139__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__28139__auto__)){
return or__28139__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__28127__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__28139__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__28139__auto__)){
return or__28139__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__46453__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__46453__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__46453__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__46453__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__46454 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__46454,(0),null);
var fn_name = cljs.core.nth.call(null,vec__46454,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__46454,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__46454,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__46454,(4),null);
var arity = cljs.core.nth.call(null,vec__46454,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__28127__auto__ = protocol_ns;
if(cljs.core.truth_(and__28127__auto__)){
return cljs.core.not.call(null,(function (){var and__28127__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__28139__auto__ = protocol_part;
if(cljs.core.truth_(or__28139__auto__)){
return or__28139__auto__;
} else {
return fn_part;
...
var o__45931__auto__ = f;
return (o__45931__auto__["getBasis"]).call(o__45931__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__28127__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__28127__auto__)){
...
}catch (e46458){var _e__45938__auto__ = e46458;
...
var G__46459 = (obj[cljs.core.first.call(null,path)]);
var G__46460 = cljs.core.rest.call(null,path);
obj = G__46459;
path = G__46460;
continue;
} else {
...
var partition_bits = (function (){var or__28139__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__28139__auto__)){
return or__28139__auto__;
} else {
return (0);
...
return (function (accum,p__46461){
var vec__46462 = p__46461;
var bit = cljs.core.nth.call(null,vec__46462,(0),null);
var protocol = cljs.core.nth.call(null,vec__46462,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__46465){
var vec__46466 = p__46465;
var ns = cljs.core.nth.call(null,vec__46466,(0),null);
var name = cljs.core.nth.call(null,vec__46466,(1),null);
var selector = cljs.core.nth.call(null,vec__46466,(2),null);
...
return (function (p__46470){
var vec__46471 = p__46470;
var munged_name = cljs.core.nth.call(null,vec__46471,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__46471,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__46471,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__46469_SHARP_){
return (obj[cljs.core.first.call(null,p1__46469_SHARP_)]);
});})(name,sorted_matches,vec__46471,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1506931543292
