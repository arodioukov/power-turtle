...
var G__46476 = devtools.prefs.pref.call(null,v);
v = G__46476;
continue;
} else {
return v;
...
var and__28127__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__28127__auto__){
var and__28127__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__28139__auto__ = (function (){try{if(!((value == null))){
...
}catch (e46479){var _e__45938__auto__ = e46479;
return false;
}})();
if(cljs.core.truth_(or__28139__auto__)){
return or__28139__auto__;
} else {
var or__28139__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e46483){var _e__45938__auto__ = e46483;
return false;
}})();
...
}catch (e46485){var _e__45938__auto__ = e46485;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__28127__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__28127__auto__)){
var and__28127__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__28127__auto____$1){
...
var and__28127__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__28127__auto__)){
...
var or__28139__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__28139__auto__)){
return or__28139__auto__;
} else {
...
var and__28127__auto__ = (function (){var or__28139__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__28139__auto__)){
return or__28139__auto__;
} else {
...
var vec__46487 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__46487,(0),null);
var name = cljs.core.nth.call(null,vec__46487,(1),null);
...
var and__28127__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__28127__auto__)){
...
var or__28139__auto__ = typeof value === 'string';
if(or__28139__auto__){
return or__28139__auto__;
} else {
var or__28139__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__46490_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__46490_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1506931543368
