...
var G__43049 = devtools.prefs.pref.call(null,v);
v = G__43049;
continue;
} else {
return v;
...
var and__28814__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__28814__auto__){
var and__28814__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__28826__auto__ = (function (){try{if(!((value == null))){
...
}catch (e43052){var _e__42067__auto__ = e43052;
return false;
}})();
if(cljs.core.truth_(or__28826__auto__)){
return or__28826__auto__;
} else {
var or__28826__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e43056){var _e__42067__auto__ = e43056;
return false;
}})();
...
}catch (e43058){var _e__42067__auto__ = e43058;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__28814__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__28814__auto__)){
var and__28814__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__28814__auto____$1){
...
var and__28814__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__28814__auto__)){
...
var or__28826__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__28826__auto__)){
return or__28826__auto__;
} else {
...
var and__28814__auto__ = (function (){var or__28826__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__28826__auto__)){
return or__28826__auto__;
} else {
...
var vec__43060 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__43060,(0),null);
var name = cljs.core.nth.call(null,vec__43060,(1),null);
...
var and__28814__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__28814__auto__)){
...
var or__28826__auto__ = typeof value === 'string';
if(or__28826__auto__){
return or__28826__auto__;
} else {
var or__28826__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__43063_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__43063_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1506931024834
