...
if(!(((!((app_db == null)))?(((false) || ((cljs.core.PROTOCOL_SENTINEL === app_db.reagent$ratom$IReactiveAtom$)))?true:(((!app_db.cljs$lang$protocol_mask$partition$))?cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,app_db):false)):cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,app_db)))){
