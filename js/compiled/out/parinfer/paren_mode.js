...
parinfer.paren_mode.append_delim_trail = (function parinfer$paren_mode$append_delim_trail(p__38941){
...
var state = map__38942__$1;
var stack = cljs.core.get.call(null,map__38942__$1,new cljs.core.Keyword(null,"stack","stack",-793405930));
var line_no = cljs.core.get.call(null,map__38942__$1,new cljs.core.Keyword(null,"line-no","line-no",-666819466));
var insert = cljs.core.get.call(null,map__38942__$1,new cljs.core.Keyword(null,"insert","insert",1286475395));
...
parinfer.paren_mode.min_indent = (function parinfer$paren_mode$min_indent(x,p__38944){
...
var stack = cljs.core.get.call(null,map__38945__$1,new cljs.core.Keyword(null,"stack","stack",-793405930));
var opener = cljs.core.peek.call(null,stack);
...
var x__29176__auto__ = (start_x + (1));
var y__29177__auto__ = x;
return ((x__29176__auto__ > y__29177__auto__) ? x__29176__auto__ : y__29177__auto__);
} else {
return x;
}
});
parinfer.paren_mode.min_dedent = (function parinfer$paren_mode$min_dedent(x,p__38947){
...
var dedent_x = cljs.core.get.call(null,map__38948__$1,new cljs.core.Keyword(null,"dedent-x","dedent-x",1097411627));
if(cljs.core.truth_(dedent_x)){
var x__29183__auto__ = dedent_x;
var y__29184__auto__ = x;
return ((x__29183__auto__ < y__29184__auto__) ? x__29183__auto__ : y__29184__auto__);
} else {
return x;
}
});
parinfer.paren_mode.correct_indent = (function parinfer$paren_mode$correct_indent(p__38950){
...
var indent_delta = cljs.core.get.call(null,map__38951__$1,new cljs.core.Keyword(null,"indent-delta","indent-delta",-1753368232));
var x_pos = cljs.core.get.call(null,map__38951__$1,new cljs.core.Keyword(null,"x-pos","x-pos",-382213783));
var stack = cljs.core.get.call(null,map__38951__$1,new cljs.core.Keyword(null,"stack","stack",-793405930));
var dedent_x = cljs.core.get.call(null,map__38951__$1,new cljs.core.Keyword(null,"dedent-x","dedent-x",1097411627));
var line_no = cljs.core.get.call(null,map__38951__$1,new cljs.core.Keyword(null,"line-no","line-no",-666819466));
var opener = cljs.core.peek.call(null,stack);
...
parinfer.paren_mode.handle_cursor_delta = (function parinfer$paren_mode$handle_cursor_delta(p__38953){
...
var state = map__38954__$1;
var indent_delta = cljs.core.get.call(null,map__38954__$1,new cljs.core.Keyword(null,"indent-delta","indent-delta",-1753368232));
var line_no = cljs.core.get.call(null,map__38954__$1,new cljs.core.Keyword(null,"line-no","line-no",-666819466));
var x_pos = cljs.core.get.call(null,map__38954__$1,new cljs.core.Keyword(null,"x-pos","x-pos",-382213783));
var cursor_line = cljs.core.get.call(null,map__38954__$1,new cljs.core.Keyword(null,"cursor-line","cursor-line",-1089611007));
var cursor_x = cljs.core.get.call(null,map__38954__$1,new cljs.core.Keyword(null,"cursor-x","cursor-x",475204266));
var cursor_dx = cljs.core.get.call(null,map__38954__$1,new cljs.core.Keyword(null,"cursor-dx","cursor-dx",133069327));
var cursor_delta_QMARK_ = (function (){var and__28814__auto__ = cljs.core._EQ_.call(null,cursor_line,line_no);
if(and__28814__auto__){
var and__28814__auto____$1 = cljs.core._EQ_.call(null,cursor_x,x_pos);
...
return cljs.core.update.call(null,G__38956,new cljs.core.Keyword(null,"indent-delta","indent-delta",-1753368232),cljs.core._PLUS_,cursor_dx);
} else {
return G__38956;
}
});
 ...
 */
parinfer.paren_mode.process_indent = (function parinfer$paren_mode$process_indent(p__38957){
...
var state = map__38958__$1;
var stack = cljs.core.get.call(null,map__38958__$1,new cljs.core.Keyword(null,"stack","stack",-793405930));
var track_indent_QMARK_ = cljs.core.get.call(null,map__38958__$1,new cljs.core.Keyword(null,"track-indent?","track-indent?",-1967553136));
var lines = cljs.core.get.call(null,map__38958__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var line_no = cljs.core.get.call(null,map__38958__$1,new cljs.core.Keyword(null,"line-no","line-no",-666819466));
var ch = cljs.core.get.call(null,map__38958__$1,new cljs.core.Keyword(null,"ch","ch",-554717905));
var x_pos = cljs.core.get.call(null,map__38958__$1,new cljs.core.Keyword(null,"x-pos","x-pos",-382213783));
var cursor_line = cljs.core.get.call(null,map__38958__$1,new cljs.core.Keyword(null,"cursor-line","cursor-line",-1089611007));
var cursor_x = cljs.core.get.call(null,map__38958__$1,new cljs.core.Keyword(null,"cursor-x","cursor-x",475204266));
var cursor_dx = cljs.core.get.call(null,map__38958__$1,new cljs.core.Keyword(null,"cursor-dx","cursor-dx",133069327));
...
var at_valid_closer_QMARK_ = (function (){var and__28814__auto__ = check_indent_QMARK_;
if(cljs.core.truth_(and__28814__auto__)){
var and__28814__auto____$1 = parinfer.reader.closing_delim_QMARK_.call(null,ch);
if(cljs.core.truth_(and__28814__auto____$1)){
...
var move_closer_QMARK_ = (function (){var and__28814__auto__ = at_valid_closer_QMARK_;
if(cljs.core.truth_(and__28814__auto__)){
...
var G__38960 = state__$1;
var G__38960__$1 = (cljs.core.truth_(move_closer_QMARK_)?parinfer.paren_mode.append_delim_trail.call(null,G__38960):G__38960);
var G__38960__$2 = parinfer.paren_mode.handle_cursor_delta.call(null,G__38960__$1)
;
if(cljs.core.truth_(at_indent_QMARK_)){
return parinfer.paren_mode.correct_indent.call(null,G__38960__$2);
} else {
return G__38960__$2;
}
});
 ...
 */
parinfer.paren_mode.process_char = (function parinfer$paren_mode$process_char(p__38961,ch){
var map__38962 = p__38961;
var map__38962__$1 = ((((!((map__38962 == null)))?((((map__38962.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38962.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38962):map__38962);
var state = map__38962__$1;
var lines = cljs.core.get.call(null,map__38962__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var line_no = cljs.core.get.call(null,map__38962__$1,new cljs.core.Keyword(null,"line-no","line-no",-666819466));
...
var G__38964 = state__$2;
if(cljs.core.truth_(new cljs.core.Keyword(null,"process?","process?",-106844121).cljs$core$IFn$_invoke$arity$1(state__$2))){
return parinfer.indent_mode.process_char_STAR_.call(null,G__38964);
} else {
return G__38964;
}
});
parinfer.paren_mode.reinsert_delims = (function parinfer$paren_mode$reinsert_delims(p__38965){
var map__38966 = p__38965;
var map__38966__$1 = ((((!((map__38966 == null)))?((((map__38966.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38966.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38966):map__38966);
var state = map__38966__$1;
var removed_delims = cljs.core.get.call(null,map__38966__$1,new cljs.core.Keyword(null,"removed-delims","removed-delims",137127226));
return cljs.core.reduce.call(null,((function (map__38966,map__38966__$1,state,removed_delims){
return (function (state__$1,_delim){
return parinfer.paren_mode.append_delim_trail.call(null,state__$1);
});})(map__38966,map__38966__$1,state,removed_delims))
...
parinfer.paren_mode.process_line.cljs$core$IFn$_invoke$arity$2 = (function (p__38971,line){
var map__38972 = p__38971;
var map__38972__$1 = ((((!((map__38972 == null)))?((((map__38972.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38972.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38972):map__38972);
var state = map__38972__$1;
var stack = cljs.core.get.call(null,map__38972__$1,new cljs.core.Keyword(null,"stack","stack",-793405930));
var lines = cljs.core.get.call(null,map__38972__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var line_no = cljs.core.get.call(null,map__38972__$1,new cljs.core.Keyword(null,"line-no","line-no",-666819466));
var cursor_line = cljs.core.get.call(null,map__38972__$1,new cljs.core.Keyword(null,"cursor-line","cursor-line",-1089611007));
...
var state__$2 = cljs.core.update_in.call(null,state__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"insert","insert",1286475395),new cljs.core.Keyword(null,"line-dy","line-dy",41667486)], null),((function (line_no__$1,state__$1,map__38972,map__38972__$1,state,stack,lines,line_no,cursor_line){
return (function (p1__38968_SHARP_){
if(cljs.core.truth_(p1__38968_SHARP_)){
return (p1__38968_SHARP_ - (1));
} else {
return null;
}
});})(line_no__$1,state__$1,map__38972,map__38972__$1,state,stack,lines,line_no,cursor_line))
);
...
parinfer.paren_mode.finalize_state = (function parinfer$paren_mode$finalize_state(p__38975){
...
var state = map__38976__$1;
var stack = cljs.core.get.call(null,map__38976__$1,new cljs.core.Keyword(null,"stack","stack",-793405930));
...
//# sourceMappingURL=paren_mode.js.map?rel=1506931008351
